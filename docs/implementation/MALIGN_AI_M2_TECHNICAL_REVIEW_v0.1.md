...
**Corrección en progreso:** los 30/30 owners de Action Cards (`GE-ACT-001…030`) ya dejaron de ejecutarse en el loop superficial y conservan sus IDs en escenarios canónicos autenticados. Estos escenarios atraviesan dispatcher, CAS, continuaciones privadas, proyección autorizada, RNG autoritativo, lifecycle, hand limit, recursos, VP, campaign activation y auditoría observable. La sustitución corrigió: Double Agent `min(5, hand)`; Discard Action sin recuperación elegible; Cyber Theft con transferencia cero; Honey Pot sin Action elegible o con tirada fallida; parámetros fijos de Leaks/Crisis no controlables por caller; Covert Thief mediante posición oculta sin IDs rivales en proyección; lifecycle del Starter robado; Double Action como slot comprometido que paga carta y segunda activación real con ordinal 2; y Boost negado consumido sin roll ni modificador. La suite no-PostgreSQL vigente reporta **497/497 PASS en 43 archivos**; la reducción histórica es eliminación de evidencia inválida, no pérdida de IDs owner. M2R-R03 permanece **OPEN** sólo para los owners superficiales restantes de M2-3/M2-6.
