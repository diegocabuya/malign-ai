...
**Corrección en progreso:** 24/30 owners de Action Cards (`GE-ACT-001…009`, `013…015`, `018…027`, `029…030`) ya dejaron de ejecutarse en el loop superficial y conservan sus IDs en escenarios canónicos autenticados. Estos escenarios atraviesan dispatcher, CAS, continuaciones privadas, proyección autorizada, RNG autoritativo, lifecycle, hand limit, recursos, VP y auditoría observable. La sustitución corrigió: Double Agent `min(5, hand)`; Discard Action sin recuperación elegible; Cyber Theft con transferencia cero; Honey Pot sin Action elegible o con tirada fallida; parámetros fijos de Leaks/Crisis no controlables por caller; y Covert Thief mediante posición oculta sin IDs rivales en proyección. Al eliminar duplicados superficiales ya sustituidos, la suite no-PostgreSQL vigente reporta **498/498 PASS en 43 archivos**; la reducción es eliminación de evidencia inválida, no pérdida de IDs owner. M2R-R03 permanece **OPEN** para `GE-ACT-010…012`, `016…017`, `028` y los owners superficiales restantes de M2-3/M2-6.
