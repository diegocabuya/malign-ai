...
**Corrección en progreso:** `M2_EFFECT_MANIFEST` materializa y prueba por igualdad exacta los 59 pares `effect_id`/`source_definition_id` del snapshot DEC-077. El dispatcher distingue ID desconocido (`EFFECT_UNKNOWN`) de ID aprobado sin handler (`EFFECT_DISABLED`), siempre sin mutación. Se implementaron los 23 bindings `CV_PAIR_BONUS` con validación de su pareja exacta, seis `TARGET_DT_SET` ligados a campaña/DT del escenario, tres efectos fijos de recursos/lifecycle, E017 con pago/descarte atómicos, E028 con muestreo sin reemplazo mediante RNG autoritativo y revelado restringido, y E046 con cuatro D10 autoritativos y transferencias todo-o-nada; sumados a los handlers previos, el dispatcher tiene 42 IDs ejecutables contando la habilidad de régimen. Nueve efectos registrados se ejecutan por eventos o continuaciones: E033 cubre `CAMPAIGN_TO_DISCARD`; E010, E012, E022 y E036 verifican la carta disparadora; E040 y E054 conservan su sujeto canónico; E016 y E047 usan una `M2_EFFECT_CARD_CHOICE` durable, hasheada, autenticada y proyectada sólo al chooser/F1. E047 genera su D10 internamente y el jugador objetivo elige el descarte; E016 conserva owner y lifecycle de retorno. Permanecen nueve IDs del manifest sin implementación completa. Los handlers parciales restantes no se contabilizan hasta cerrar sus interacciones. M2R-R04 continúa **OPEN** y no se presenta el inventario como cobertura funcional 59/59.
